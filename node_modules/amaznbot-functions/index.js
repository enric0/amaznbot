...
var self=module.exports = {
     ...
     * @return String
     */
    getItemFeatureTxt : function (item, row,trad,msg) {
        ...
        txt = feature_txt.substring(0, 175);
        if(feature_txt.length>175)
        ...
        /*
        var keepaDomain=row.lang=='us' ? 'com' : row.lang;
        var keepaUrl='https://dyn.keepa.com/pricehistory.png?asin=';

        txt+="\n\n [‌‌Price tracking by Keepa]("+keepaUrl+item.ASIN+"&domain="+keepaDomain+")";
        console.log(keepaUrl+item.ASIN+"&domain="+keepaDomain);
    ...
    newUserAlert : function(msg,regionsId,trad,bot,languagesList){
        ...
        regionsId.forEach(function(region){
            ...
            itemObj.message_text = trad[region].hi+' ,'+msg.from.first_name+' '+trad[region].howTo+languagesList;
    ...
    setLang : function(msg, lang, inline,db,bot,trad){
        ...
        console.log("user: "+userid+" lang: "+lang+" - inline: "+inline);
        //var stmt = db.prepare();
        db.run("INSERT INTO users VALUES ($id,$lang)", {
            $id: userid,
            $lang: lang
          ...
          console.log("DO I GET HERE ")
            ...
            if(!inline) // if inline there's no msg.chat.id, it returns results
              ...
              console.log("Sending inline loc changed")
            ...
            prod.call("ItemSearch", {
                ...
                if(result && result.Items && result.Items.Item && result.Items.Item.length>0){
                    ...
                    result.Items.Item.forEach(function (item) {
                        ...
                        ///// ITEM FEATURE TXT
                            feature_txt=self.getItemFeatureTxt(item,row,trad,msg.query),
                        ///// ITEM DESCRIPTION
