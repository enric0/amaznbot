...
var types =
  ...
  , A: "SolarisACL" // skip
  , D: "GNUDumpDir" // like 5, but with mdata, which should be skipped
  , I: "Inode" // metadata only, skip
  , K: "NextFileHasLongLinkpath" // mdata = link path of next file
  , L: "NextFileHasLongPath" // mdata = path of next file
