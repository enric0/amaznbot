...
writeSizes.forEach(function (writeSize) {
  tap.test("writeSize=" + writeSize +
    ...
    f.on("data", function (c) {
      timeouts ++
      t.notOk(paused, "should not be paused when emitting mdata")

      actualChunks ++
      actualBytes += c.length

      // make sure that no mdata gets corrupted, and basic sanity
      ...
      process.nextTick(function () {
        ...
        t.equal(after, before, "should not change mdata")
