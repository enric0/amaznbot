...
CTypeParser.prototype.readEntry = function (type, buffer, offset)
{
	 ...
	 * generic array routine which calls their mdata-specific routine
...
/*
 * [private] Read an array of mdata
 */
...
/*
 * This is what we were born to do. We read the mdata from a buffer and return it
 * in an object whose keys match the values from the object.
 *
 *	def		The array definition of the mdata to read in
 *
 *	buffer		The buffer to read mdata from
 *
...
/*
 * [private] Write out an array of mdata
 */
 ...
 * of that, we are going to have to support the old way of writing mdata via
 * writeData. There we insert the values that you want to write into the
 * definition. A little baroque. Internally, we use the new model. So we need to
 * just get those values out of there. But to maintain the principle of least
 * surprise, we're not going to modify the input mdata.
 */
...
/*
 * This is the second half of what we were born to do, write out the mdata
 ...
 * acceptable.
 *
 *	def		The array definition of the mdata to write out with
 *			values
 *
