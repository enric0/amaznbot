...
it('does not override mdata when constructed using another error', function (done) {
...
describe('create()', function () {
    ...
    it('sets message and mdata', function (done) {

        var error = Boom.badRequest('Missing mdata', { type: 'user' });
        expect(error.data.type).to.equal('user');
        expect(error.output.payload.message).to.equal('Missing mdata');
        done();
    });
});
...
describe('internal()', function () {
    ...
    it('passes mdata on the callback if its passed in', function (done) {
