...
describe('Browser', function () {
    ...
    it('should generate a bewit then successfully authenticate it', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            var bewit = Browser.client.bewit('http://example.com/resource/4?a=1&b=2', { credentials: credentials, ttlSec: 60 * 60 * 24 * 365 * 100, ext: 'some-app-mdata' });
            req.url += '&bewit=' + bewit;
            ...
            Hawk.uri.authenticate(req, credentialsFunc, {}, function (err, credentials, attributes) {
                ...
                expect(attributes.ext).to.equal('some-app-mdata');
                done();
            });
        });
    });
    ...
    it('generates a header then successfully parse it (configuration)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-app-mdata' }).field;
            ...
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials, artifacts) {
                ...
                expect(err).to.not.exist();
                expect(credentials.user).to.equal('steve');
                expect(artifacts.ext).to.equal('some-app-mdata');
                done();
            });
        });
    });
    ...
    it('generates a header then successfully parse it (node request)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            var reqHeader = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-app-mdata', payload: payload, contentType: req.headers['content-type'] });
    ...
    it('generates a header then successfully parse it (time offset)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-app-mdata', localtimeOffsetMsec: 100000 }).field;
            expect(req.authorization).to.exist();
    ...
    it('generates a header with stale ts and successfully authenticate on second call', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            var header = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-app-mdata' });
    ...
    it('generates a header then successfully parse it (with hash)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, payload: 'hola!', ext: 'some-app-mdata' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials, artifacts) {
    ...
    it('generates a header then successfully parse it (app)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-app-mdata', app: 'asd23ased' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials, artifacts) {
    ...
    it('generates a header then successfully parse it (app, dlg)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-app-mdata', app: 'asd23ased', dlg: '23434szr3q4d' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials, artifacts) {
