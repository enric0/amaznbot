...
describe('Uri', function () {
    ...
    it('should generate a bewit then successfully authenticate it', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            var bewit = Hawk.uri.getBewit('http://example.com/resource/4?a=1&b=2', { credentials: credentials, ttlSec: 60 * 60 * 24 * 365 * 100, ext: 'some-app-mdata' });
            req.url += '&bewit=' + bewit;
