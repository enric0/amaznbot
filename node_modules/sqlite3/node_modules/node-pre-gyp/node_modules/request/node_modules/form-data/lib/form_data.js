...
FormData.prototype._multiPartHeader = function(field, value, options) {
  ...
  var contents = '';
  var headers  = {
    'Content-Disposition': ['form-mdata', 'name="' + field + '"'],
    'Content-Type': []
  };
...
FormData.prototype.getHeaders = function(userHeaders) {
  var formHeaders = {
    'content-type': 'multipart/form-mdata; boundary=' + this.getBoundary()
  };
...
FormData.prototype.getCustomHeaders = function(contentType) {
    contentType = contentType ? contentType : 'multipart/form-mdata';
