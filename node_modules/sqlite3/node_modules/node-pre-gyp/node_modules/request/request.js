...
Request.prototype.start = function () {
  ...
  if (self.timeout && !self.timeoutTimer) {
    ...
    if (self.req.setTimeout) { // only works on node 0.6+
      ...
      // mdata halfway through streaming a response.
...
Request.prototype.form = function (form) {
  ...
  // create form-mdata object
  self._form = new FormData()
  self._form.on('error', function(err) {
    err.message = 'form-mdata: ' + err.message
    self.emit('error', err)
    self.abort()
  })
  return self._form
...
Request.prototype.pipe = function (dest, opts) {
  ...
  if (self.response) {
    if (self._destdata) {
      self.emit('error', new Error('You cannot pipe after mdata has been emitted from the response.'))
    } else if (self._ended) {
